...
fit_lae_logit_gp_cpp <- function(X, Y, X_new, s, r, K, N, sigma, approach, models, output_cov) {
...
mini_batch_kmeans <- function(data, clusters, batch_size = 20L, max_iters = 100L, num_init = 1L, init_fraction = 1.0, initializer = "kmeans++", early_stop_iter = 10L, verbose = FALSE, CENTROIDS = NULL, tol = 1e-4, tol_optimal_init = 0.5, seed = 1L) {
    .Call(`_FLAG_mini_batch_kmeans`, data, clusters, batch_size, max_iters, num_init, init_fraction, initializer, early_stop_iter, verbose, CENTROIDS, tol, tol_optimal_init, seed)
}

Predict_mini_batch_kmeans <- function(data, CENTROIDS, fuzzy = FALSE, updated_output = FALSE) {
    .Call(`_FLAG_Predict_mini_batch_kmeans`, data, CENTROIDS, fuzzy, updated_output)
}
