...
the spectral properties of heat kernels. The package also includes 
Gaussian process logistic regression and multinomial logistic regression with Polya-Gamma samplers.
