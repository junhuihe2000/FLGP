...
Rcpp::List fit_lae_logit_mult_gp_cpp(Eigen::MatrixXd X, Eigen::VectorXd Y, Eigen::MatrixXd X_new,
                                int s, int r, int K,
                                double sigma, std::string approach,
                                Rcpp::List models) {
...
Rcpp::List fit_se_logit_mult_gp_cpp(Eigen::MatrixXd X, Eigen::VectorXd Y, Eigen::MatrixXd X_new,
                               int s, int r, int K,
                               double sigma, std::vector<double> a2s, std::string approach,
                               Rcpp::List models) {
...
Rcpp::List fit_nystrom_logit_mult_gp_cpp(Eigen::MatrixXd X, Eigen::VectorXd Y, Eigen::MatrixXd X_new,
                                    int s, int K,
                                    double sigma, std::vector<double> a2s, std::string approach,
                                    Rcpp::List models) {
...
Rcpp::List fit_gl_logit_mult_gp_cpp(Eigen::MatrixXd X, Eigen::VectorXd Y, Eigen::MatrixXd X_new,
                               int K,
                               double sigma, std::vector<double> a2s,
                               double threshold, bool sparse,
                               std::string approach,
